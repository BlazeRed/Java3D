...
public class HelloJava3DTraslazione extends Applet{
	
	public HelloJava3DTraslazione() {
	...
	public TransformGroup createSubGraph(){
		  ...
		  td3.setTranslation(new Vector3d(0.8d, 0d, 0d)); // def. traslazione
	...
	public static void main(String[] args) {
		new MainFrame(new HelloJava3DTraslazione(), 1024, 768);	
	}
}
