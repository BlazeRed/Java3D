...
public class Earth extends Applet{
	...
	public BranchGroup createSceneGraph() {
		...
		Sphere earth = new Sphere(1.0f, Primitive.GENERATE_NORMALS | Primitive.GENERATE_TEXTURE_COORDS, 200, createAppearance() );
		...
		//aggiunta delle varie componenti alla scena
