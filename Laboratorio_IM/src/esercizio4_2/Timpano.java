...
public class Timpano extends Shape3D{
	...
	public Timpano(float altezza, float larghezza, float profondita) {
		...
		vertex[0] = new Point3d(-larg, 0, 0); 
		vertex[1] = new Point3d(0, alt, 0);
		vertex[2] = new Point3d(larg, 0, 0); 
		vertex[3] = vertex[1]; 
		vertex[4] = new Point3d(larg, 0, -prof); 
		vertex[5] = new Point3d(0, alt, -prof);
		vertex[6] = new Point3d(-larg, 0, -prof);
		vertex[7] = vertex[1];
		vertex[8] = vertex[0];
		vertex[9] = vertex[4];
